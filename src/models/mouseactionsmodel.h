...
private:
    ...
    const QMap<QString, QString> m_defaultKeys{
        {QStringLiteral("Left"),       QStringLiteral("playPauseAction")},
        {QStringLiteral("Leftx2"),     QStringLiteral("toggleFullscreenAction")},
        {QStringLiteral("Right"),      QStringLiteral("openContextMenuAction")},
        {QStringLiteral("Middle"),     QStringLiteral("muteAction")},
        {QStringLiteral("Forward"),    QStringLiteral("seekForwardSmallAction")},
        {QStringLiteral("Back"),       QStringLiteral("seekBackwardSmallAction")},
        {QStringLiteral("ScrollUp"),   QStringLiteral("volumeUpAction")},
        {QStringLiteral("ScrollDown"), QStringLiteral("volumeDownAction")},
    };
    // clang-format on
};
