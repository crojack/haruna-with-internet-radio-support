...
Page {
    ...
    // FIX: Monitor window size changes properly
    onWidthChanged: {
    ...
    // FIX: Simpler refresh timer - only refreshes when really needed
    Timer {
        id: refreshTimer
        interval: 100
        running: false
    ...
    // FIX: Refresh on overlay setting changes only
    Connections {
    ...
    Rectangle {
        ...
        ColumnLayout {
            id: mainLayout
            anchors.fill: parent
            spacing: Kirigami.Units.smallSpacing  // Add space between tabs and content
            ...
            TabBar {
                ...
                implicitWidth: 0  // Fix binding loop
                ...
                onCurrentIndexChanged: {
                    ...
                    // Updated: Do NOT stop playback when switching tabs
                    // Simply update the visible playlist index
            ...
            Item {
                ...
                Layout.topMargin: Kirigami.Units.smallSpacing  // Add space below tabs
