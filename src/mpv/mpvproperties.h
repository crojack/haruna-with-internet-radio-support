...
public:
    ...
    const QString KeepOpen{QStringLiteral("keep-open")};

    Q_PROPERTY(QString EofReached MEMBER EofReached CONSTANT)
    const QString EofReached{QStringLiteral("eof-reached")};

    Q_PROPERTY(QString ReplayGain MEMBER ReplayGain CONSTANT)
    const QString ReplayGain{QStringLiteral("replaygain")};

    Q_PROPERTY(QString ReplayGainPreamp MEMBER ReplayGainPreamp CONSTANT)
    const QString ReplayGainPreamp{QStringLiteral("replaygain-preamp")};

    Q_PROPERTY(QString ReplayGainClip MEMBER ReplayGainClip CONSTANT)
    const QString ReplayGainClip{QStringLiteral("replaygain-clip")};

    Q_PROPERTY(QString ReplayGainFallback MEMBER ReplayGainFallback CONSTANT)
    const QString ReplayGainFallback{QStringLiteral("replaygain-fallback")};
